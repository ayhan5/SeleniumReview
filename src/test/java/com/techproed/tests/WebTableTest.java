...
public class WebTableTest extends TestBase {
    ...
    public void tumsatirlar() {
        //saydaki tum satirlar :tbody/tr
        List<WebElement> satirlar = driver.findElements(By.xpath("//tbody/tr"));
        for (WebElement w : satirlar) {
            System.out.println(w.getText());

        //sadece tablodaki 5.satiri console da yazdirmak icin
//        List<WebElement> satir5 = driver.findElements(By.xpath("//tbody/tr[5]"));
//        for (WebElement w : satir5) {
//            System.out.println(w.getText());
        }
    }
    @Test
    ...
    @AfterMethod //**tum claslari calistitirsak hata aliriz cunku bir method kullanmadik...close() kullanirsak SANIRIM hata almayiz..kontrol et !!
