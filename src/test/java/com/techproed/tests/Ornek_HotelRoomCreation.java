...
/*-user name ve password girip login butonuna tiklayin
-acilan sayadaki tum meytin kutularina istediginiz verileri girin ama dropdown butonuna dikkat edin
-save butonuna basin
-hotel was inserted succesfully textini dogrulayin
-ok butonuna basin
 */
public class Ornek_HotelRoomCreation extends TestBase {
    ...
    public void test() {
        ...
        WebElement descKutusu = driver.findElement(By.xpath("(//textarea)[2]"));//ins ayapaken //textarea yazdiktan sonra cikan contl F kurusunda kac tane oldugu gorulur ////By.xpath("//textarea[@role='textbox']"
